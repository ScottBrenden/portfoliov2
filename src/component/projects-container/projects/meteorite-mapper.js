    ...
    return(
      <div id='mm' className='project'>
        ...
        <div className='project-info-odd cols'>
          <p className='pg-emph'>Meteorite Mapper is a web app that allows for the veiwing of meteorite landing locations on a global map. </p>
          ...
          <p className='pg-content'>The app is written in JavaScript, using NodeJS jQuery, Ajax, pageJS and Express. In order to prevent unnessicary calls to NASA's API a SQL database was set up for data persistance after the initial call.</p>
