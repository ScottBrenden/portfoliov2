    ...
    return (
      <div id='ltg' className='project'>
        ...
        <div className='project-info-odd cols'>
          ...
          <p className='pg-content'>Many games have matchmaking lobbies or places to join play groups. A significant number of games do not however, and some that do have poorly functioning systems. This is where looking to Game comes in. Sign up, create a play group or join an existing one.</p>
